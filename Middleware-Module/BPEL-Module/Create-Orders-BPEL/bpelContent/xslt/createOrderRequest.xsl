...
<xsl:stylesheet version="1.0"
	...
	<oracle-xsl-mapper:schema>
		...
		<!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) 
			AT [TUE SEP 29 09:36:27 COT 2015]. -->
	</oracle-xsl-mapper:schema>
	...
	<xsl:template match="/">
		<tns:createSalesOrder>
			<order>
				...
				<custDocumentNumber>
					<xsl:value-of
						select="/ns0:CreateSalesOrderRequest/order/custDocumentNumber" />
				</custDocumentNumber>
				<custDocumentType>
