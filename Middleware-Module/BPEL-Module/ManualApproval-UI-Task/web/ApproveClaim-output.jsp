...
createTaskOutput = function() {checked="true"
    ...
    if(outputVal == 'approve') {
		return '<sch:ClaimApprovalResponse xmlns:sch="http://touresbalon.com.co/salesorder/schema/utility/1.0.0"><sch:approved>true</sch:approved></sch:ClaimApprovalResponse>';
	} else if (outputVal == 'disapprove') {
		return '<sch:ClaimApprovalResponse xmlns:sch="http://touresbalon.com.co/salesorder/schema/utility/1.0.0"><sch:approved>false</sch:approved></sch:ClaimApprovalResponse>';
	}
};
